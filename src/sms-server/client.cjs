...
var Client = /** @class */ (function () {
    ...
    Client.main = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var client, commandLineArgs, phoneNumber, formattedNumber, sendSmsRequest, runtime, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        client = Client.createClient(process.env['ALIBABA_CLOUD_ACCESS_KEY_ID'], process.env['ALIBABA_CLOUD_ACCESS_KEY_SECRET']);
